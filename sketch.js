...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    // Escribe una condición para que el estado de juego "gameState" termine
    if(obstaclesGroup.isTouching(kangaroo)){
      collidedSound.play();
      gameState = END;
    }
    // Escribe una condición para que la puntuación incremente
...
function reset(){
  ...
  // Destruye los arbustos y el grupo de obstáculos
